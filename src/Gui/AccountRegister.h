  ...
  private:
    ...
    : public Wt::WContainerWidget
    {
      public:
        ...
        auto setPresent   ( GCW_NUMERIC _value )-> void;
        auto setFuture    ( GCW_NUMERIC _value )-> void;
        auto setCleared   ( GCW_NUMERIC _value )-> void;
        auto setReconciled( GCW_NUMERIC _value )-> void;
        auto setProjected ( GCW_NUMERIC _value )-> void;
