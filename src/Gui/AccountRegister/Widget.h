#line 2 "src/Gui/AccountRegister/Widget.h"

#ifndef __GUI_ACCOUNTREGISTER_WIDGET_H___
#define __GUI_ACCOUNTREGISTER_WIDGET_H___
...
//    auto batchEditModel  ()-> std::shared_ptr< BatchEditModel  >  { return m_batchEditModel;  }
  ...
  private:
    ...
    **
    */
//    auto editor()-> Editor & { return m_editor; }
